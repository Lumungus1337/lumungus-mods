...
- Ein automatisierter Lasttest prueft aktuell 36 echte Kisten mit 59.904 Items und 12 Itemtypen. Die reproduzierbare Ausgangsmessung steht in [PERFORMANCE_BASELINE.md](PERFORMANCE_BASELINE.md).
...
2. Den synthetischen Lasttest auf deutlich mehr Inventare und Itemtypen skalieren; danach dekorative Trims ergaenzen.
