...
| Server-GameTests | `PASS uat.45` | 37 Storage-Tests, 4 Machines-Tests und 3 Integrationstests pruefen einschliesslich rekursivem Fass-Crafting aus Eichenstaemmen. |
| Client-GameTest | `PASS uat.45` | Storage- und Machines-Clients laden Designer-Texturen, Tablet-Icons, JEI, Blockstates und gerichtete Modellvarianten ohne fehlende Ressourcen. |
