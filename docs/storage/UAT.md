...
- Version: `0.1.0-uat.24`
- Minecraft: `26.2`
- Fabric Loader: `0.19.5`
- Fabric API: `0.158.0+26.2`
- Optional fuer Rezepttransfer: JEI `30.28.0.193`
- Build: `./gradlew clean build storageUatBundle`
- Testpaket: `build/uat/lumungus-storage-0.1.0-uat.24.zip`
- Abnahmestatus: `AUTOMATED_SERVER_PASS`; Arbeitszyklen, gerichtete Arbeitsseiten, tragbare Storage Interfaces, Wireless Inventory Connectoren und Wireless-Reichweiten jenseits der Kurzdistanz sind automatisiert geprueft, manueller Interaktions- und Multiplayer-UAT sind weiter offen
...
RC-Version: `0.1.0-uat.24`  Tester: `________________`  Datum: `________________`
