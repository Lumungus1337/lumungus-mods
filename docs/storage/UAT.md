...
- Testpaket: `build/uat/lumungus-storage-0.1.0-uat.40.zip`
...
| Server-GameTests | `PASS uat.40` | Storage und Machines pruefen physische Inventare, Arbeitsbloecke, Funkmodule, Funkverbindungen, Rohrpostrohre, Chunk-Grenzen, Lastfaelle, Crafting und den Autocrafter. |
| Client-GameTest | `PASS uat.40` | Der Fabric-Client startet; Terminal-Suche sowie Autocrafter-Menge, Pause und Hotkey-Fokus bestehen die Clienttests. |
...
RC-Version: `0.1.0-uat.40`  Tester: `________________`  Datum: `________________`
