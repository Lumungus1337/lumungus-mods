...
- Version: `0.1.0-uat.20`
- Minecraft: `26.2`
- Fabric Loader: `0.19.5`
- Fabric API: `0.158.0+26.2`
- Optional fuer Rezepttransfer: JEI `30.28.0.193`
- Build: `./gradlew clean build storageUatBundle`
- Testpaket: `build/uat/lumungus-storage-0.1.0-uat.20.zip`
- Abnahmestatus: `AUTOMATED_SERVER_PASS`; Arbeitszyklen fuer Output, Breaker, Placer und Wireless sind automatisiert geprueft, manueller Interaktions- und Multiplayer-UAT sind weiter offen
...
RC-Version: `0.1.0-uat.20`  Tester: `________________`  Datum: `________________`
